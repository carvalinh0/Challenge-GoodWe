...
import 'gerenciar_planta_model.dart';
export 'gerenciar_planta_model.dart';
...
class GerenciarPlantaWidget extends StatefulWidget {
  const GerenciarPlantaWidget({super.key});

  static String routeName = 'gerenciarPlanta';
  static String routePath = '/gerenciarPlanta';

  @override
  State<GerenciarPlantaWidget> createState() => _GerenciarPlantaWidgetState();
}

class _GerenciarPlantaWidgetState extends State<GerenciarPlantaWidget> {
  late GerenciarPlantaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GerenciarPlantaModel());
                    ...
                    children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Builder(
                                  builder: (context) {
                                    final listaVisitante =
                                        _model.listaVisitantes.toList();
                                    ...
                                    return ListView.separated(
                                      ...
                                      shrinkWrap: true,
                                      scrollDirection: Axis.vertical,
                                      itemCount: listaVisitante.length,
                                      separatorBuilder: (_, __) =>
                                          SizedBox(height: 8.0),
                                      itemBuilder:
                                          (context, listaVisitanteIndex) {
                                        final listaVisitanteItem =
                                            listaVisitante[listaVisitanteIndex];
                                        return Padding(
                                          padding: EdgeInsets.all(12.0),
                                          child: Row(
                                            mainAxisSize: MainAxisSize.max,
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          ...
                          text: 'Modificar Planta de Energia',
                          icon: Icon(
                            Icons.edit,
                            size: 24.0,
                          ),
